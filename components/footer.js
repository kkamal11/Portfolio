        ...
        <footer class="clear-both p-4 bg-white sm:p-6 dark:bg-gray-900">
            <div class="flex items-center justify-center">
                <div class="my-8 md:px-36 sm:px-14 text-gray-700">
                    <a href="https://github.com/kkamal11" class="hover:text-cyan-500 inline-block mr-6" target="_blank"><i class="bi bi-github" style="font-size:50px"></i></a>
                    <a href="https://www.linkedin.com/in/kamal-kishor-chaurasiya-a22866192" class=" hover:text-cyan-500 inline-block mr-6" target="_blank"><i class="bi bi-linkedin" style="font-size:50px"></i></a>
                    <a href="mailto:reachmeviamaill@gmail.com" class="hover:text-cyan-500 inline-block mr-6"><i class="bi bi-google" style="font-size:50px"></i></a>
                    <a href="https://instagram.com/kkamal3?igshid=ZDdkNTZiNTM=" class="hover:text-cyan-500 inline-block" target="_blank"><i class="bi bi-instagram" style="font-size:50px"></i></a>
                </div>
            </div>
