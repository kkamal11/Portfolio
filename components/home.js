    ...
    <div id="home">
        <div class="dark:text-gray-100 py-20 ">
            <div class="grid justify-items-center sm:text-2xl lg:text-3xl lg:font-medium">
                <p class="hover-underline-animation text-rose-100 rounded-md p-2 md:mb-2">"Hello<span class="hidden md:visible"> World</span>!" I am Kamal.<span class="hidden md:visible">&#128075;</span></p>
